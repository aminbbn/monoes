      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        >
           ...
           <div className="relative bg-navy-900/60 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden transform transition-transform duration-700 hover:rotate-x-1 h-[450px] md:h-[550px] w-full">
              ...
              {/* Glossy Reflection Gradient - Moved behind content via mix-blend or z-index if needed, but pointer-events-none helps */}
              ...
              <div className="absolute inset-0 top-10 flex items-center justify-center">
                 ...
                 {/* Using viewBox="0 0 100 100" allows us to use standard percentage coordinates without pixel math */}
                 ...
                 {/* The container uses absolute inset-0 to match the parent size for accurate percentage positioning */}
                 ...
                 {/* 5. Atmospheric Particles - Z-0 or Z-40 depending on desired effect */}
...
// ... [Existing MultiPlatformFeature, LinkedInView, EmailView, components] ...
const MultiPlatformFeature = () => {
  ...
  const platforms = [
    { 
      ...
      color: 'bg-[#0077b5]', 
      text: "Hi Sarah, impressive work scaling TechFlow's marketing team! 🚀\n\nI noticed you're prioritizing data privacy. Monoes helps CMOs automate outreach.",
      cta: 'Connect'
    },
    { 
      id: 'email', 
      ...
      icon: <Mail size={20} />, 
      color: 'bg-[#EA4335]', 
      text: "Local-first automation for TechFlow", // Subject for email
      body: "Hi Sarah,\n\nI saw your recent post about the challenges of AI compliance.\n\nMonoes solves this by running entirely on your device.",
      cta: 'Send Email'
    },
    { 
      id: 'twitter', 
      ...
      color: 'bg-black', 
      text: "Just read your thread on AI safety @sarahjenkins 🛡️\n\nWe built Monoes exactly for this—100% local sales automation.",
      cta: 'Post Reply'
    },
    {
      id: 'instagram',
      ...
      text: "Hey Sarah! 👋 Loved your story about the AI summit. We're helping creators automate DMs without getting shadowbanned.",
      cta: 'Message'
    },
    {
      id: 'tiktok',
      ...
      icon: <Video size={20} />,
      color: 'bg-black',
      text: "Yo Sarah! Saw your viral clip on AI tools. 🔥\nYou should try Monoes for automating your partnership outreach. It's local & safe.",
      cta: 'Send'
    },
  ];
           ...
           {platforms.map((p) => (
             <button key={p.id} onClick={() => handleTabClick(p.id)} className={`w-full flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300 group text-left relative overflow-hidden ${activeTab === p.id ? 'bg-navy-800 border-white/20 shadow-xl shadow-black/50' : 'bg-navy-900/50 border-white/5 hover:bg-navy-800 hover:border-white/10'}`}>
               ...
               <div className="flex-1 relative z-10">
                 ...
                 <div className="text-xs text-gray-500 font-medium">{activeTab === p.id ? 'Drafting Message...' : 'View Integration'}</div>
               </div>
...
const LinkedInView = () => (
  <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 1.05 }} transition={{ duration: 0.3 }} className="w-full h-full bg-[#1b1f23] rounded-3xl border border-gray-700 overflow-hidden flex flex-col shadow-2xl relative">
    ...
    <div className="flex-1 bg-[#1b1f23] p-6 flex flex-col gap-6 overflow-y-auto">
       ...
       <div className="self-end max-w-[90%]">
          <div className="bg-[#0a66c2] text-white p-4 rounded-tl-2xl rounded-bl-2xl rounded-br-2xl text-base shadow-lg leading-relaxed"><TypewriterEffect text="Hi Sarah, impressive work scaling TechFlow's marketing team! 🚀 I noticed you're prioritizing data privacy. Monoes helps CMOs automate outreach while keeping all data 100% local." /></div>
    ...
    <div className="p-4 border-t border-gray-700 bg-[#1b1f23]">
       <div className="bg-[#2d3238] rounded-full px-6 py-4 flex items-center justify-between border border-transparent hover:border-gray-600 transition-colors">
          <span className="text-gray-400 text-sm font-medium">Write a message...</span>
          <div className="flex gap-4 text-gray-400"><ImageIcon size={20} className="hover:text-white cursor-pointer" /><Paperclip size={20} className="hover:text-white cursor-pointer" /><Smile size={20} className="hover:text-white cursor-pointer" /></div>
       </div>
    </div>
  </motion.div>
);
...
const EmailView = () => (
  <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 1.05 }} transition={{ duration: 0.3 }} className="w-full h-full bg-white text-gray-900 rounded-3xl border border-gray-200 overflow-hidden flex flex-col shadow-2xl relative">
    <div className="bg-[#f2f6fc] px-6 py-4 border-b border-gray-200 flex justify-between items-center shadow-sm z-10">
       <div className="text-base font-semibold text-gray-700">New Message</div><X size={20} className="text-gray-500 cursor-pointer hover:text-gray-800" />
    </div>
    <div className="px-6 py-3 border-b border-gray-100 flex items-center gap-3">
       <span className="text-gray-500 text-sm font-medium w-10">To:</span><span className="bg-white border border-gray-200 px-3 py-1 rounded-full text-sm flex items-center gap-2 shadow-sm text-gray-700 font-medium"><img src="https://i.pravatar.cc/150?img=5" alt="" className="w-5 h-5 rounded-full" />Sarah Jenkins <X size={14} className="cursor-pointer text-gray-400 hover:text-red-500" /></span>
    </div>
    <div className="px-6 py-3 border-b border-gray-100">
       <div className="text-gray-500 text-xs font-semibold uppercase tracking-wider mb-1">Subject</div><div className="text-gray-900 font-bold text-lg">Local-first automation for TechFlow</div>
    </div>
    <div className="flex-1 p-8 text-base leading-7 text-gray-800 font-sans overflow-y-auto">
       <p className="mb-6">Hi Sarah,</p><p className="mb-6">I saw your recent post about the challenges of AI compliance.</p>
       <div className="mb-6 text-blue-800 bg-blue-50 p-4 rounded-xl border border-blue-100 shadow-sm inline-block"><TypewriterEffect text="Monoes solves this by running entirely on your device—no cloud, no data leaks." /></div>
       ...
       <div className="flex items-center gap-4 text-gray-500 pt-6 border-t border-gray-100">
          ...
          <div className="text-sm"><div className="font-bold text-gray-800">Monoes Team</div><div>Local AI Sales Automation</div><div className="text-blue-500 text-xs mt-0.5">www.monoes.com</div></div>
       </div>
    </div>
    <div className="p-4 border-t border-gray-100 bg-white flex justify-between items-center shadow-[0_-5px_20px_rgba(0,0,0,0.02)]">
       <div className="flex items-center gap-2"><button className="bg-[#0b57d0] text-white px-8 py-2.5 rounded-full font-bold text-sm shadow-md hover:bg-blue-700 hover:shadow-lg transition-all">Send</button><div className="text-gray-400 hover:text-gray-600 p-2 cursor-pointer"><Paperclip size={20} /></div></div>
       <div className="flex gap-4 text-gray-400"><ImageIcon size={20} className="hover:text-gray-600 cursor-pointer" /><Lock size={20} className="hover:text-gray-600 cursor-pointer" /></div>
    </div>
  </motion.div>
);

const TwitterView = () => (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full h-full bg-black rounded-3xl border border-gray-800 flex items-center justify-center text-gray-500">Twitter UI Placeholder</motion.div>); 
const InstagramView = () => (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full h-full bg-black rounded-3xl border border-gray-800 flex items-center justify-center text-gray-500">Instagram UI Placeholder</motion.div>);
const TikTokView = () => (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full h-full bg-black rounded-3xl border border-gray-800 flex items-center justify-center text-gray-500">TikTok UI Placeholder</motion.div>);
